...
namespace FLGrainInterfaces
{
    ...
    public interface IGame : IGrainWithGuidKey
    {
        ...
        Task<(string category, TimeSpan? roundTime, bool mustChooseGroup, IEnumerable<GroupInfoDTO> groups)> StartRound(Guid id);
        Task<(string category, TimeSpan roundTime)> ChooseGroup(Guid id, ushort groupID);
