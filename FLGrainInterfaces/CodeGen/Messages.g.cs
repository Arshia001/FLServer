...
namespace FLGrainInterfaces
{
    ...
    public class GroupInfoDTO
    {
        ...
        public static implicit operator GroupInfoDTO(GroupConfig obj) => new GroupInfoDTO(obj.Name, obj.ID);
